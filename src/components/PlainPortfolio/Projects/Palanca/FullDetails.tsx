    ...
    return (
        <>
            ...
            <p>
                Description:{' '}
                <span className="gray">
                    A personal website developed for my High School Batch. A
                    place where other people (aimed at younger batches) can send
                    us letters, whether anonymously or not.
                </span>
            </p>
